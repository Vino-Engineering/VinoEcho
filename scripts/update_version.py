...
def main():
  ...
  plistpath = scriptpath + "/resources/VinoEcho-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VinoEcho-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VinoEcho-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VinoEcho-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VinoEcho-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/VinoEcho.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/VinoEcho.iss",inplace=1):
