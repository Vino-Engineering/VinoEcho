...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=VinoEcho Demo Installer\n"
      else:
        line="OutputBaseFilename=VinoEcho Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the VinoEcho Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the VinoEcho installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=VinoEcho Demo installer\n"
     else:
       line="SetupWindowTitle=VinoEcho installer\n"
